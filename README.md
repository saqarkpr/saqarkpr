...
- Reinforcement Learning (theory and deep RL)
- Symbolic and neuro-symbolic reasoning
- LLM post-training (DPO, GRPO, RLHF / RL from verified feedback)
- Sequence modeling and attention mechanisms (Transformers, long-range dependencies)
- Trustworthy and evaluable AI (calibration, hallucination, RAG evaluation)
- Physics-informed learning (Fredholm integral equations, neural operators)
